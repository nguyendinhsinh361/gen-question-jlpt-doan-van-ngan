...
```bash
python3 .gemini/skills/jlpt-reading-short-passage-post-qc/scripts/post_qc.py \
...
```bash
python3 .gemini/skills/jlpt-reading-short-passage/scripts/check_furigana.py --html-dir assets/html/doan_van_ngan --level-from-filename --csv rules/kanji_jlpt_sensei.csv
python3 .gemini/skills/jlpt-reading-short-passage/scripts/check_spacing.py --html-dir assets/html/doan_van_ngan --level-from-filename
python3 .gemini/skills/jlpt-reading-short-passage/scripts/check_csv_fields.py --csv sheets/samples_v1.csv --kind short
python3 .gemini/skills/jlpt-reading-short-passage/scripts/check_answer_punctuation.py --csv sheets/samples_v1.csv
```
...
4. **Chạy lại QC**: Chạy lại post_qc.py trên toàn bộ CSV:
   ```bash
   python3 .gemini/skills/jlpt-reading-short-passage-post-qc/scripts/post_qc.py --csv sheets/samples_v1.csv --verbose
   ```
...
- **Đọc lại rules**: Trước khi sửa, đọc lại rule liên quan trong `rules/` và `.gemini/skills/jlpt-reading-short-passage/SKILL.md`.
